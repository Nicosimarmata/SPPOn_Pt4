                ...
                <div class="nav-container">
                    <nav id="main-menu-navigation" class="navigation-main">
                        ...
                        <div class="nav-item has-sub">
                            <a href="javascript:void(0)"><i class="ik ik-layers"></i><span>Data Master</span> <span class="badge badge-danger">150+</span></a>
                            <div class="submenu-content">
                                <a href="{{route('admin.dtsiswa')}}" class="menu-item">Data Siswa</a>
                                <a href="{{route('admin.dtadmin')}}" class="menu-item">Data Admin</a>
                                <a href="pages/widget-data.html" class="menu-item">Data Kelas</a>
                            </div>
                        </div>
